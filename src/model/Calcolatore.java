...
public class Calcolatore {
    ...
    public static NumeroComplesso multiply(NumeroComplesso n1, NumeroComplesso n2){
        ...
        double parte_real = n2.getRealPart() * n1.getRealPart() - (n1.getComplexPart() * n2.getComplexPart());
        double parte_imaginary = n1.getRealPart()*n2.getComplexPart() + n1.getComplexPart()* n2.getRealPart();
        NumeroComplesso result = new NumeroComplesso(parte_real, parte_imaginary);
        return(result);
    }
